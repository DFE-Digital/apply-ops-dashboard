...
RSpec.describe Deployers do
  ...
  describe '.for_today' do
    ...
    it 'returns different values on different days' do
      deployers_for_jan_1 = deployers_for_jan_2 = nil

      Timecop.travel(2019,1,1) do
        deployers_for_jan_1 = Deployers.for_today
      end
      Timecop.travel(2019,1,2) do
        deployers_for_jan_2 = Deployers.for_today
      end

      expect(deployers_for_jan_1).not_to eq(deployers_for_jan_2)
    end
  end
end
